  ...
  return (
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20, marginBottom: 24 }}>
        ...
        <div style={{ border: '2px solid var(--np-ink)', background: '#fff', padding: 20, boxShadow: '4px 4px 0 0 var(--np-ink)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, borderBottom: '2px solid var(--np-ink)', paddingBottom: 10, marginBottom: 16 }}>
            <Radio size={18} />
          ...
          <div style={{ maxHeight: 150, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 8 }} className="custom-scrollbar">
            {metrics?.websockets?.kiosks?.length === 0 ? (
              ...
              metrics?.websockets?.kiosks?.map((k, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 12, border: '1px solid var(--np-muted)', padding: '6px 10px', background: 'var(--np-bg)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: 24, alignItems: 'start' }}>
        ...
        <div style={{ border: '2px solid var(--np-ink)', background: '#fff', padding: 20, boxShadow: '4px 4px 0 0 var(--np-ink)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '2px solid var(--np-ink)', paddingBottom: 10, marginBottom: 16 }}>
          ...
          <div style={{ maxHeight: 400, overflowY: 'auto' }} className="custom-scrollbar">
            {metrics?.solver?.runs?.length === 0 ? (
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid var(--np-ink)', textAlign: 'left', fontWeight: 700 }}>
                    ...
                    <tr key={i} style={{ borderBottom: '1px solid var(--np-muted)', background: r.status === 'FAIL' ? '#fff5f5' : 'transparent' }}>
                      ...
                      <td style={{ padding: '8px 4px' }}>
                        ...
                        {r.status === 'FAIL' && r.infeasible_causes && (
                          <div style={{ fontSize: 9, color: 'var(--np-red)', marginTop: 4, fontFamily: 'var(--font-mono)', wordBreak: 'break-all' }}>
        ...
        <div style={{ border: '2px solid var(--np-ink)', background: '#fff', padding: 20, boxShadow: '4px 4px 0 0 var(--np-ink)' }}>
          ...
          <div style={{ border: '2px dashed var(--np-ink)', background: 'var(--np-bg)', padding: 12, marginBottom: 16, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, maxHeight: 250, overflowY: 'auto' }} className="custom-scrollbar">
            {backups.length === 0 ? (
              ...
              backups.map((b, i) => (
                <div key={i} style={{ border: '1px solid var(--np-ink)', padding: 12, background: 'var(--np-bg)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                    ...
                    <button 
                      ...
                      disabled={restoring || backingUp}
                      style={{ padding: 4, color: 'var(--np-red)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      ...
      <div style={{ marginTop: 24, border: '2px solid var(--np-ink)', background: '#fff', padding: 24, boxShadow: '4px 4px 0 0 var(--np-ink)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20, marginBottom: 20 }}>
          ...
          <div style={{ border: '2px solid var(--np-ink)', padding: 16, background: metrics?.security?.auditLogSecurity?.valid ? '#f0fdf4' : '#fff5f5' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, borderBottom: '2px solid var(--np-ink)', paddingBottom: 8, marginBottom: 12 }}>
          ...
          <div style={{ border: '2px solid var(--np-ink)', padding: 16, background: 'var(--np-bg)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, borderBottom: '2px solid var(--np-ink)', paddingBottom: 8, marginBottom: 12 }}>
              <span style={{ fontSize: 16 }}>⏰</span>
            ...
            <div style={{ fontSize: '12px', display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              {metrics?.backups?.autoBackup?.error && (
                <div style={{ color: 'var(--np-red)', fontFamily: 'var(--font-mono)', fontSize: 10 }}>
        ...
        <div style={{ border: '2px solid var(--np-ink)', padding: 16 }}>
                ...
                <tbody>
                  {metrics?.database?.slowQueries?.map((q, i) => (
                    <tr key={i} style={{ borderBottom: '1px solid var(--np-muted)' }}>
                      ...
                      <td style={{ padding: '6px 4px', color: 'var(--np-red)', fontWeight: 700 }}>{q.duration}ms</td>
