...
async function runTests() {
  ...
  try {
    // Select 10 subjects of the SAME branch, year, and semester (which all conflict with each other)
    const subjects = db.prepare("SELECT * FROM subjects WHERE branch='CSE' AND year='SY' AND semester=3 LIMIT 10").all();
